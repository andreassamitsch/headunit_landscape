...
# Let callers explicitly keep the current right-hand tab for WebRadio playback.
replace_once(
...
# Every WebRadio start keeps the WebRadio tab open.
web_radio_path = "app/src/main/kotlin/com/metrolist/music/ui/screens/radio/WebRadioScreen.kt"
replace_once(
    web_radio_path,
...
# Radio artist click: use right-pane resolver on Dudu7, standard search as fallback.
replace_once(
...
# Resolve radio artists and navigate entirely inside the Dudu7 right pane.
vehicle_path = "app/src/dudu7/kotlin/com/metrolist/music/variant/VehicleLandscapeLayout.kt"
replace_once(
    vehicle_path,
...
# Replace the logo resolver with a raster-first, regional-page-aware implementation.
Path("app/src/main/kotlin/com/metrolist/music/radio/RadioStationLogoResolver.kt").write_text(
    r'''/**
...
# Strengthen the existing deterministic UI test.
test_path = "scripts/dudu7_webradio_reliability_smoke.sh"
replace_once(
    test_path,
...
# Start a third favorite with ambiguous metadata.''',
    '''grep -E 'Applied high-resolution radio cover.*Rick Astley.*Never Gonna Give You Up.*1200' "$RESULTS_DIR/cover-log.txt"
echo "PASS: clear artist/title received a strongly matched 1200px cover"
...
print("WebRadio 13.6.6 patch applied")
